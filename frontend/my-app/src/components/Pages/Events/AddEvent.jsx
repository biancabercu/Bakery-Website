...
const url = "http://localhost:5001/api/v1/events/addevent"
    ...
    return (
        ...
        <br></br><br></br><br></br><br></br><br></br><br></br>
            <form>
                ...
                <br></br>
                <button onClick={handleAddEvent}>Adauga evenimentul!</button>
                <br></br>
