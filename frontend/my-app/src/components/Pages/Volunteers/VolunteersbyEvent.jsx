...
const url = "http://localhost:5001/api/v1/users/getvolunteers"
...
function VolunteerbyEvent() {
    const [eventName, setEventName] = useState('');

    const handleEventName = event => {
        setEventName(event.target.value);
    };
    const handleVolunteerbyEvent = () => {
        const data = {
            'eventName': eventName,
            'userName': 'client'
        };
        axios.post(url, data, {
            ...
            .then((response) => {
                alert('VolunteerbyEvent complete!')
            })
    ...
    return (
        ...
        <div className="forms">
            ...
            <form>
                ...
                <br></br>
                <button onClick={handleVolunteerbyEvent}>Cauta voluntarii</button>
                <br></br>
...
export default VolunteerbyEvent;